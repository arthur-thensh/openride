...
static int64_t v4_coarse_global_cells(const V4CoarseMap *map)
{
                 ...
                 size_t error_size)
{
    ...
    V4CoarseMap local_urban = {.zoom = OPENRIDE_ORMAP_AREA_LOCAL_ZOOM};
    ...
    /* Each v5 landcover LOD uses the same ORA1 triangle encoding. Green is
                          ...
                          size_t error_size)
{
    ...
    if (stats_out) {
        /* v5 keeps semantic built-up masks instead of final contour triangles. */
